...
The keys provided in the configuration have to be in (JSON web key)[https://datatracker.ietf.org/doc/html/rfc7517#section-4] format.
They can be generated by a script, using some JSON Object Signing and Encryption library.
